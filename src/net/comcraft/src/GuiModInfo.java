...
public class GuiModInfo extends GuiScreen {
    ...
    protected void customDrawScreen() {
        ...
        drawStringInLines(cc.g, text, 10, 10, Comcraft.screenWidth - 10 * 2, Graphics.TOP | Graphics.LEFT);
    }

    protected void initGui() {
        elementsList.addElement(new GuiButtonSmall(cc, 0, 3, Comcraft.screenHeight - 3 - GuiButtonSmall.getButtonHeight(), "Back"));
    }
